...
![インポートしたデータで福山市の島を選択した様子](https://storage.googleapis.com/zenn-user-upload/yh0ld4dduibklre8jcauu4qzmnr6)
...
![ST_Collectを実行した結果](https://storage.googleapis.com/zenn-user-upload/cz5md03eeh9tazbppti1fzcamwba)
